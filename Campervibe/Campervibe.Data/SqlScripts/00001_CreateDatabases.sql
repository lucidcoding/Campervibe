...
IF EXISTS (SELECT * FROM sysdatabases WHERE name='Campervibe') 
BEGIN 
	EXEC msdb.dbo.sp_delete_database_backuphistory @database_name = N'Campervibe'
	ALTER DATABASE [Campervibe] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
	DROP DATABASE [Campervibe]
END
GO

CREATE DATABASE [Campervibe] 
GO
